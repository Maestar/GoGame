...
public class GoGameUI extends JFrame {
			...
			JButton[][] buttonGrid = new JButton[9][9];
	       	for (int x = 0; x < 9; x++) {
	       		for (int y = 0; y < 9; y++) {
	                ...
	                {	//coded by Jason, internal if statements by Tera
	       				@Override
	...
	private void showTimerUI() {
		...
		timerList.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				switch (option) {
				case "30 seconds": turnTimeLimitSaved = 30;
					break;
				case "45 seconds": turnTimeLimitSaved = 45;
					break;
				case "1 minute": turnTimeLimitSaved = 60;
					break;
				case "1.5 minutes": turnTimeLimitSaved = 90;
					break;
				case "3 minutes": turnTimeLimitSaved = 180;
					break;
				case "5 minutes": turnTimeLimitSaved = 300;
					break;
				default: turnTimeLimitSaved = 30;
				}
		}});
	...
	private void showRecordsUI() {
		...
		public void actionPerformed(ActionEvent e) {
			...
			recordsDisplay.setText(""); //Use this to set text (may have to use a loop to set the lines properly.
		}});
    ...
    private void showLoginUI(){
            ...
            loginbtn.addActionListener(new ActionListener()
            {
                public void actionPerformed(ActionEvent e) {
                     ...
                     *
                     * else if(database.login(userInput1, userInput2, userPass1, userPass2) == true){
                        remove(loginPanel);
                        add(gamePanel);
                        repaint();
                        revalidate();  
                    ...
                    */
                    else{ //this is just placeholder code to make it function without the database for testing purposes.
                        remove(loginPanel);
                        add(gamePanel);
                        repaint();
                        revalidate();
        ...
        public void getCreds(JTextField usrname, JTextField usrname2, JPasswordField pass, JPasswordField pass2){
            ...
            userPass2 = new String(pass.getPassword());
