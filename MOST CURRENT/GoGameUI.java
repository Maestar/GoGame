    ...
    private JPanel drawBoard(int[][] board) {
        ...
        for (int x = 0; x < 9; x++) {
            for (int y = 0; y < 9; y++) {
                ...
                Icon icon;
                if (board[x][y] == 1) {
                    icon = new ImageIcon("C:\\Users\\Nachte\\eclipse-workspace\\GoGame\\goGame\\black.png");
                } else if (board[x][y] == 2) {
                    icon = new ImageIcon("C:\\Users\\Nachte\\eclipse-workspace\\GoGame\\goGame\\white.png");
                } else {
                    icon = new ImageIcon("C:\\Users\\Nachte\\eclipse-workspace\\GoGame\\goGame\\icon.png");
                }
